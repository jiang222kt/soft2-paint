...
typedef enum res{ EXIT, LINE, RECT, CIRCLE, LOAD, CHPEN, UNDO, SAVE, UNKNOWN, ERRNONINT, ERRLACKARGS} Result;
...
void load_history(Canvas *c, History *his, const char *filename);
